...
/**
 * This is a basic container annotation for ExceptionHandling annotations and the
...
public @interface CatchHandler {
     ...
     * method.
     * 
     * @return The exception wraps that should be considered when intercepting
     * a method.
     */
    @Nonbinding
    ...
    /**
     * The exception which should be handeled by this exception handler by default
     * if no exception handling exists, that would handle an exception that occured.
     * Every exception that is instanceof the given exception type,
     * will be handeled by this handler.
     * 
