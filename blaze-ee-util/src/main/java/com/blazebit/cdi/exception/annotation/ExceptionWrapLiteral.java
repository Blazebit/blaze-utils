...
public class ExceptionWrapLiteral extends AnnotationLiteral<ExceptionWrap> implements ExceptionWrap {
    ...
    public ExceptionWrapLiteral() {
        this(new Class[]{java.lang.Throwable.class}, java.lang.Exception.class);
    }
    ...
    public ExceptionWrapLiteral(Class<? extends Throwable>[] sources, Class<? extends Exception> wrapper) {
