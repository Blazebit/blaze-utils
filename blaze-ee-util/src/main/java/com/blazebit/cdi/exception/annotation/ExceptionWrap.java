...
/**
 * This annotation is used within ExceptionWrapping annotation and declares
 * the wrapping of source annotations to wrapper annotations.
 * 
...
public @interface ExceptionWrap {
     ...
     * 
     * @return The wrapper type into which the given source types should be wrapped to
     */
    @Nonbinding
