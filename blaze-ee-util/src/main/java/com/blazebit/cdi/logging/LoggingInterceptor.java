 ...
 *
 *      @Logging
 *      public String example(String value) throws Exception{
 ...
 * </code>
 *
 * Invocation: bean.example("test"); Log result: Bean.example(test) called
 * Bean.example() returned test
 *
 * Invocation: bean.example(null); Log result: Bean.example(null) called
 * Bean.example() returned null
 *
 * Invocation: bean.example(""); Log result: Bean.example("") called
 * Bean.example() returned null Bean.example() throwed Exception with the
