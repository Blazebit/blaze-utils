...
public class SchedulerBean implements Serializable {
    ...
    public String getSchedulerStatus(Object schedulerConfig) throws SchedulerException {
        return getSchedulerStatus((SchedulerConfiguration) schedulerConfig);
    }

    public String getSchedulerStatus(SchedulerConfiguration schedulerConfig) throws SchedulerException {
        try {
    ...
    public String deleteScheduler(SchedulerConfiguration schedulerConfig) {
        ...
        try {
            SchedulerRepository.getInstance().remove(schedulerConfig.getSchedulerName());
        } catch (Exception ex) {
            // Don't care
        }
    ...
    public String startScheduler(SchedulerConfiguration schedulerConfig) throws SchedulerException {
        if (schedulerConfig.getScheduler() != null) {
    ...
    public String shutdownScheduler(SchedulerConfiguration schedulerConfig) throws SchedulerException {
        if (schedulerConfig.getScheduler() != null) {
    ...
    public String standbyScheduler(SchedulerConfiguration schedulerConfig) throws SchedulerException {
        if (schedulerConfig.getScheduler() != null) {
    ...
    public String resumeScheduler(SchedulerConfiguration schedulerConfig) throws SchedulerException {
        if (schedulerConfig.getScheduler() != null) {
    ...
    public String pauseScheduler(SchedulerConfiguration schedulerConfig) throws SchedulerException {
        if (schedulerConfig.getScheduler() != null) {
