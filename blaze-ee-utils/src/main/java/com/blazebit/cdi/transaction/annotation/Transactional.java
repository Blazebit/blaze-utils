...
public @interface Transactional {
	 ...
	 * and may not just join a parent transaction. This feature is not yet
	 * implemented because JTA does not provide support for nested transations.
	 * 
	 * @return If true the intercepted method requires a new transaction,
	 *         otherwise it may join a parent transaction
	 */
