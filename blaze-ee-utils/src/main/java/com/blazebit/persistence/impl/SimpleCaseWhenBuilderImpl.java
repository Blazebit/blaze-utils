...
public class SimpleCaseWhenBuilderImpl<T> implements SimpleCaseWhenBuilder<T> {
    ...
    public SimpleCaseWhenBuilderImpl(T result, String caseOperandExpression) {
        this.result = result;
        this.caseOperandExpression = ExpressionUtils.parseCaseOperand(caseOperandExpression);
    ...
    public SimpleCaseWhenBuilder<T> when(String expression, String thenExpression) {
        ...
        whenExpression[0] = ExpressionUtils.parseScalarExpression(expression);
        whenExpression[1] = ExpressionUtils.parseScalarExpression(thenExpression);
