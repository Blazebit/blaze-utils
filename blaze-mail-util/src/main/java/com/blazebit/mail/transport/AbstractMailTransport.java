...
public abstract class AbstractMailTransport implements MailTransport {
    ...
    protected String hostProperty = new StringBuilder("mail.").append(getProtocol()).append(".host").toString();
    protected String portProperty = new StringBuilder("mail.").append(getProtocol()).append(".port").toString();
    protected String authentificationProperty = new StringBuilder("mail.").append(getProtocol()).append(".auth").toString();
    protected String userProperty = new StringBuilder("mail.").append(getProtocol()).append(".username").toString();
    protected String passwordProperty = new StringBuilder("mail.").append(getProtocol()).append(".password").toString();
