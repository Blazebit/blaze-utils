...
public class GenericComparatorTest {
    ...
    public void testGenericCompareViaPropertyPath() {
        List<GenericComparatorTest.TestObject> actual = Arrays.asList(new TestObject(new TestObject("4")),
                new TestObject(new TestObject("3")), new TestObject(new TestObject("2")), new TestObject(new TestObject("1")));
        List<GenericComparatorTest.TestObject> expected = Arrays.asList(new TestObject(new TestObject("1")),
                new TestObject(new TestObject("2")), new TestObject(new TestObject("3")), new TestObject(new TestObject("4")));
        Collections.sort(actual, new GenericComparator<GenericComparatorTest.TestObject>("member.stringValue"));
    ...
    public void testGenericCompareWithInvalidPropertyPathMemeberDoesReturnNull() {
        ...
        List<GenericComparatorTest.TestObject> expected = Arrays.asList(new TestObject(new TestObject("1")),
                new TestObject(new TestObject("2")), new TestObject(new TestObject("3")), new TestObject(new TestObject("4")));
        Collections.sort(actual, new GenericComparator<GenericComparatorTest.TestObject>("member.memeber.stringValue"));
        assertEquals(expected, actual);
    }
    ...
    public void testGenericCompareWithInvalidPropertyPathMemberDoesNotExist() {
        ...
        List<GenericComparatorTest.TestObject> expected = Arrays.asList(new TestObject(new TestObject("1")),
                new TestObject(new TestObject("2")), new TestObject(new TestObject("3")), new TestObject(new TestObject("4")));
        Collections.sort(actual, new GenericComparator<GenericComparatorTest.TestObject>("member.stringValuesssssss"));
        assertEquals(expected, actual);
    }
}
