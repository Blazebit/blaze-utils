...
public class TrieMapTest {
    ...
    public void testGetBestMatch() throws Exception {
        assertEquals("/page/main/projects/", map().getBestMatch("/page/main/projects/ai-utils"));
    }
    ...
    public void testInsertOrder2() throws Exception {
        ...
        splitMap.put("/page/main/projects/triemap", "/pages/projectDetails.xhtml");
        splitMap.put("/page/main/projects", "/pages/projects.xhtml");
        splitMap.put("/page/main/pictures", "/pages/pictures.xhtml");
    ...
    public void testKeySet() throws Exception {
        ...
        expectedMap.put("/page/main/projects/triemap", "/pages/projectDetails.xhtml");
    ...
    public void testSubMapGetBestMatch() throws Exception {
        assertEquals("/main/projects/", map().subMap("/page").getBestMatch("/main/projects/ai-utils"));
    }
    ...
    public void testSubMapContainsKeyPrefix() throws Exception {
        ...
        assertFalse(map().subMap("/").containsKeyPrefix("something that does not exist"));
    }
    ...
    public void testSubMapInsertOrder2() throws Exception {
        ...
        splitSubMap.put("page/main/projects/triemap", "/pages/projectDetails.xhtml");
    ...
    public void testSubMapKeySet() throws Exception {
        ...
        assertEquals(expectedMap.keySet(), map().subMap("/page/main/projects").keySet());
    }
    ...
    public void testSubMapEntrySet() throws Exception {
        ...
        expectedMap.put("/triemap", "/pages/projectDetails.xhtml");
        expectedMap.put("", "/pages/projects.xhtml");
        assertEquals(expectedMap.entrySet(), map().subMap("/page/main/projects").entrySet());
    }
    ...
    public void testSubMapValues() throws Exception {
        ...
        expectedMap.put("/triemap", "/pages/projectDetails.xhtml");
        expectedMap.put("", "/pages/projects.xhtml");
        assertTrue(expectedMap.values().containsAll(map().subMap("/page/main/projects").values()));
    }

    @Test
    public void testSubMap() throws Exception {
        assertEquals(map().subMap("/page/main"), map().subMap("/page").subMap("/main"));
        ...
        assertEquals("/pages/aiUtils.xhtml", originalMap.get("/page/main/projects/ai-utils"));
