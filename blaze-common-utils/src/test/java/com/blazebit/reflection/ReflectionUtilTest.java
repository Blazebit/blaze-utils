...
public class ReflectionUtilTest {
	...
	public void testResolveTypeVariable() throws Exception {
		...
		TypeVariable<?> typeVariable = (TypeVariable<?>) ReflectionUtil
				.getField(ConcreteClassA.class, "field").getGenericType();
		Class<?> concreteType = ReflectionUtil.resolveTypeVariable(
				ConcreteClassA.class, typeVariable);
		assertEquals(Integer.class, concreteType);

		typeVariable = (TypeVariable<?>) ((ParameterizedType) ReflectionUtil
				.getField(ConcreteClassA.class, "fieldCollection")
				.getGenericType()).getActualTypeArguments()[0];
		concreteType = ReflectionUtil.resolveTypeVariable(ConcreteClassA.class,
				typeVariable);
		assertEquals(Integer.class, concreteType);
		...
		typeVariable = (TypeVariable<?>) ReflectionUtil.getGetter(
		...
		typeVariable = (TypeVariable<?>) ReflectionUtil.getSetter(
		...
		typeVariable = (TypeVariable<?>) ReflectionUtil.getMethod(
	...
	public void testGetMethodExceptionTypes() throws Exception {
		assertEquals(Exception.class, ReflectionUtil.getMethodExceptionTypes(
	...
	public void testGetResolvedMethodReturnType() throws Exception {
		assertEquals(Integer.class, ReflectionUtil.getResolvedMethodReturnType(
				ConcreteClassA.class,
				ReflectionUtil.getGetter(ConcreteClassA.class, "field")));
		assertNull(ReflectionUtil.getResolvedMethodReturnType(
				ConcreteClassA.class, ""));
	}
	...
	public void testGetResolvedMethodReturnTypeArguments() throws Exception {
		assertEquals(Integer.class,
				ReflectionUtil.getResolvedMethodReturnTypeArguments(
						ConcreteClassA.class, ReflectionUtil.getGetter(
		...
		assertArrayEquals(new Class<?>[0],
				ReflectionUtil.getResolvedMethodReturnTypeArguments(
						ConcreteClassA.class, "throwsException"));
		assertNull(ReflectionUtil.getResolvedMethodReturnTypeArguments(
				ConcreteClassA.class, ""));
	}
	...
	public void testGetResolvedMethodParameterTypes() throws Exception {
		assertEquals(
				Integer.class,
				ReflectionUtil.getResolvedMethodParameterTypes(
						ConcreteClassA.class,
						ReflectionUtil.getSetter(ConcreteClassA.class, "field"))[0]);
		assertArrayEquals(new Class<?>[0],
				ReflectionUtil.getResolvedMethodParameterTypes(
						ConcreteClassA.class, "throwsException"));
		assertNull(ReflectionUtil.getResolvedMethodParameterTypes(
				ConcreteClassA.class, ""));
	}
	...
	public void testGetResolvedMethodExceptionTypes() throws Exception {
		assertEquals(Exception.class,
				ReflectionUtil.getResolvedMethodExceptionTypes(
						ConcreteClassA.class, ReflectionUtil.getMethod(
								ConcreteClassA.class, "throwsException"))[0]);
		assertArrayEquals(new Class<?>[0],
				ReflectionUtil.getResolvedMethodExceptionTypes(
						ConcreteClassA.class, "getField"));
		assertNull(ReflectionUtil.getResolvedMethodExceptionTypes(
				ConcreteClassA.class, ""));
	}
	...
	public void testGetSuperTypes() {
		assertTrue(ReflectionUtil.getSuperTypes(ClassB.class).contains(
				ClassB.class));
		assertTrue(ReflectionUtil.getSuperTypes(ClassB.class).contains(
				ClassA.class));
		...
		assertTrue(ReflectionUtil.getSuperTypes(ClassA.class).contains(
				ClassA.class));
	...
	public void testGetFieldType() {
		assertEquals(ReflectionUtil.getFieldType(ClassB.class, "B_FIELD"),
				Integer.class);
		assertEquals(ReflectionUtil.getFieldType(ClassB.class, "A_FIELD"),
				String.class);
		assertNull(ReflectionUtil.getFieldType(ClassA.class, "B_FIELD"));
		assertEquals(ReflectionUtil.getFieldType(ClassA.class, "A_FIELD"),
				String.class);
		assertEquals(ReflectionUtil.getFieldType(A.class, "A_FIELD"),
				String.class);
		assertEquals(ReflectionUtil.getFieldType(B.class, "B_FIELD"),
				Integer.class);
		assertNull(ReflectionUtil.getFieldType(B.class, "A_FIELD"));
		assertEquals(ReflectionUtil.getFieldType(C.class, "C_FIELD"),
				boolean.class);
		assertNull(ReflectionUtil.getFieldType(C.class, "B_FIELD"));
		assertEquals(ReflectionUtil.getFieldType(C.class, "A_FIELD"),
				String.class);
	}
	...
	public void testGetMethodType() {
		assertEquals(ReflectionUtil.getMethodReturnType(ClassB.class, "getA"),
				String.class);
		assertEquals(ReflectionUtil.getMethodReturnType(ClassA.class, "getA"),
				String.class);
		assertEquals(ReflectionUtil.getMethodReturnType(A.class, "getA"),
				String.class);
		assertEquals(ReflectionUtil.getMethodReturnType(C.class, "getA"),
				String.class);
		assertNull(ReflectionUtil.getMethodReturnType(B.class, "getA",
				String.class));
		assertEquals(ReflectionUtil.getMethodReturnType(ClassB.class, "isB"),
				boolean.class);
		assertEquals(ReflectionUtil.getMethodReturnType(ClassA.class, "isB"),
				boolean.class);
		assertEquals(ReflectionUtil.getMethodReturnType(A.class, "isB"),
				boolean.class);
		assertEquals(ReflectionUtil.getMethodReturnType(C.class, "isB"),
				boolean.class);
		assertNull(ReflectionUtil.getMethodReturnType(B.class, "isB"));

		assertEquals(ReflectionUtil.getMethodReturnType(ClassB.class, "setA",
				String.class), void.class);
		assertEquals(ReflectionUtil.getMethodReturnType(ClassA.class, "setA",
				String.class), void.class);
		assertEquals(ReflectionUtil.getMethodReturnType(A.class, "setA",
				String.class), void.class);
		assertEquals(ReflectionUtil.getMethodReturnType(C.class, "setA",
				String.class), void.class);
		assertNull(ReflectionUtil.getMethodReturnType(B.class, "setA",
				String.class));
		assertEquals(ReflectionUtil.getMethodReturnType(ClassB.class, "setB",
				boolean.class), void.class);
		assertEquals(ReflectionUtil.getMethodReturnType(ClassA.class, "setB",
				boolean.class), void.class);
		assertEquals(ReflectionUtil.getMethodReturnType(A.class, "setB",
				boolean.class), void.class);
		assertEquals(ReflectionUtil.getMethodReturnType(C.class, "setB",
				boolean.class), void.class);
		assertNull(ReflectionUtil.getMethodReturnType(B.class, "setB",
				boolean.class));
	}
	...
	public void testGetMethod() {
		...
		assertNotNull(ReflectionUtil.getMethod(ClassB.class, "setA",
				String.class));
		assertNotNull(ReflectionUtil.getMethod(ClassA.class, "setA",
				String.class));
		...
		assertNotNull(ReflectionUtil.getMethod(ClassB.class, "setB",
				boolean.class));
		assertNotNull(ReflectionUtil.getMethod(ClassA.class, "setB",
				boolean.class));
