...
public final class StringUtils {
	...
	public static String join(CharSequence delimiter, CharSequence... parts){
		return join(new StringBuilder((parts.length + delimiter.length()) * 10), delimiter, parts).toString();
	}
	
	public static StringBuilder join(StringBuilder sb, CharSequence delimiter, CharSequence... parts){
		if(parts.length == 0){
			return sb;
		}
	...
	public static <X, Y> String join(CharSequence delimiter, Iterable<X> parts, ValueRetriever<X, Y> expression){
	...
	public static <X, Y> StringBuilder join(StringBuilder sb, CharSequence delimiter, Iterable<X> parts, ValueRetriever<X, Y> expression){
	...
	public static <X, Y> String join(CharSequence delimiter, Iterator<X> iter, ValueRetriever<X, Y> expression){
	...
	public static <X, Y> StringBuilder join(StringBuilder sb, CharSequence delimiter, Iterator<X> iter, ValueRetriever<X, Y> expression){
		if(!iter.hasNext()){
			return sb;
		}
