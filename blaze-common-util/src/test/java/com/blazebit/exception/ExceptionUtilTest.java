...
public class ExceptionUtilTest {
    ...
    public void testUnwrapInvocationTargetException() {
        ...
        assertEquals(ExceptionUtil.unwrapInvocationTargetException(outer), inner);
        outer = new InvocationTargetException(outer);
        assertEquals(ExceptionUtil.unwrapInvocationTargetException(outer), inner);
        assertEquals(ExceptionUtil.unwrapInvocationTargetException(inner), inner);
        assertNull(ExceptionUtil.unwrapInvocationTargetException(new InvocationTargetException(null)));
    }
    ...
    public void testUnwrap() {
        Throwable inner = new RuntimeException();
        Throwable outer = new InvocationTargetException(inner);
        assertEquals(ExceptionUtil.unwrap(outer, InvocationTargetException.class), inner);
