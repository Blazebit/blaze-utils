...
public class LazyGetterMethod {
     ...
     * field names as a string separated by '.' (dots).
     * Using this constructor is equal to
     * #{@link LazyGetterMethod#LazyGetterMethod(java.lang.Object,
     * java.lang.String[]) } with the second parameter
     * <code>fieldNames.split("\\.")</code>.
     * 
     * @param source The object on which to invoke the first getter
     * @param fieldNames The field names which should be used for the getter determination
     */
     ...
     * First the source object is used as invocation target for the first getter
     * then the results of the previous operations will be used for the
     * invocation.
     * 
