...
public class MethodException {
    ...
    public Class<?> getType(){
        return method != null ? method.getExceptionTypes()[index] : constructor.getExceptionTypes()[index];
    }
    
    public Class<?> getResolvedType(Class<?> concreteClass){
        Type t = method != null ? method.getGenericExceptionTypes()[index] : constructor.getGenericExceptionTypes()[index];
