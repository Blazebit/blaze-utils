 ...
 * java.lang classes for the methods. The only exception is, that #{@link Stereotype}
 * is used for annotation 'inheritance'.
 *
...
public class AnnotationUtil {
    ...
    public static Set<Annotation> getAllAnnotations(Class<?> clazz) {
        ...
        while (!annotationTypes.isEmpty()) {
            ...
            if (stereotypeAnnotationClass != null && annotationType.isAnnotationPresent(stereotypeAnnotationClass)) {
                // If the stereotype annotation is present examaine the 'inherited' annotations
     ...
     * {@link #findAnnotation(java.lang.Class, java.lang.Class) } is used to
     * find the annotation on class level.
     *
     * @param <T> The annotation type
     * @param m The method in which to look for the annotation
     * @param clazz The class in which to look for the annotation if it can not
     * be found on method level
