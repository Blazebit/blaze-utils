...
public class FormatUtil {
     ...
     * can be used for conversion. <br/> For the following types implementations
     * are already mapped to their classes: <ul> <li>primitive int and #{@link Integer}</li>
     * <li>primitive long and #{@link Long}</li> <li>primitive double and #{@link Double}</li>
     * <li>primitive float and #{@link Float}</li> <li>primitive boolean and #{@link Boolean}</li>
     * <li>primitive char and #{@link Character}</li> <li>primitive byte and #{@link Byte}</li>
     * <li>primitive short and #{@link Short}</li> <li>#{@link String}</li> <li>#{@link BigDecimal}</li> <li>#{@link BigInteger}</li> <li>#{@link Date}</li> <li>#{@link Calendar}</li> <li>#{@link Locale}</li> <li>#{@link TimeZone}</li> <li>#{@link Currency}</li> <li>#{@link Class}</li>
     * </ul>
     *
     ...
     * Invoking this method is equal to invoking #{@link
     * ReflectionUtil#getParsedValue(java.lang.Class, java.lang.String,
     * java.text.DateFormat, java.text.DateFormat)} and the 3rd argument
     * <code>DateFormat.getDateTimeInstance()</code>
     *
    ...
    public static Serializable getParsedValue(Class<?> returnType, String value) throws ParseException {
        return getParsedValue(returnType, value, java.text.DateFormat.getDateTimeInstance());
    }
