...
public class SimpleSendMailJob extends AbstractSendMailJob implements CdiAwareJob{
    ...
    private static final Logger log = LoggerFactory.getLogger(SimpleSendMailJob.class);

    @Override
    public void execute(JobExecutionContext jec) throws JobExecutionException {
        sendMail(jec.getMergedJobDataMap(),
                 createMail(jec.getMergedJobDataMap(),
                            getRequiredParam(jec.getMergedJobDataMap(), "to").split(","),
