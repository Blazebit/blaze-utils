...
public abstract class AbstractSendMailJob extends AbstractJob {
    ...
    protected Mail createMail(JobDataMap dataMap, String[] to, String subject, String text, String html) {
        return MailUtil.createMessage(getRequiredParam(dataMap, "from"), to, subject, text, html);
    }
    ...
    protected Mail createMail(JobDataMap dataMap, String[] to, String subject, String text, String html, File[] files) throws IOException {
        return MailUtil.createMessage(getRequiredParam(dataMap, "from"), to, subject, text, html, files);
    }
    ...
    public List<JobParameter> getParameters() {
        List<JobParameter> l = new ArrayList<JobParameter>(super.getParameters());
