...
public class FireHistoryEntry implements Serializable {
    ...
    public FireHistoryEntry(String schedulerName, TriggerKey triggerKey, JobKey jobKey, Date scheduledTime, Date firedTime, TriggerState state, long runTime, JobDataMap dataMap) {
